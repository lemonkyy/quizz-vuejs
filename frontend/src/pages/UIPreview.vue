...
<template>
  <div class="p-6 space-y-12">
    ...
    <div class="flex flex-row gap-8 flex-wrap">
      ...
      <Input id="input2" theme="primary" type="text" placeholder="Enter text" dashedBorder v-model="input2" />
    ...
    <div class="flex flex-row gap-8 flex-wrap">
      ...
      <Checkbox id="checkbox2" label="" theme="primary" v-model="checkbox2" />
      <Checkbox id="checkbox3" label="primary checkbox" theme="secondary" v-model="checkbox3" />
    </div>
  </div>
</template>
